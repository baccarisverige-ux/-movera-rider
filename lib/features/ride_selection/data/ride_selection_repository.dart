...
class RideSelectionRepository {
  List<RideCatalogItem> rides() => const [
    ...
    RideCatalogItem(
      id: 'comfort',
      image: 'assets/images/rides/comfort.webp',
      name: 'Comfort',
    ...
    RideCatalogItem(
      id: 'premium',
      image: 'assets/images/rides/premium.webp',
      name: 'Premium',
    ...
    RideCatalogItem(
      id: 'priority',
      image: 'assets/images/rides/priority.webp',
      name: 'Priority',
    ...
    RideCatalogItem(
      id: 'xl',
      image: 'assets/images/rides/xl.webp',
      name: 'Movera XL',
    ...
    RideCatalogItem(
      id: 'electric',
      image: 'assets/images/rides/electric.webp',
      name: 'Electric',
    ...
    RideCatalogItem(
      id: 'pet',
      image: 'assets/images/rides/pet.webp',
      name: 'Movera Pet',
  ...
  List<RidePaymentItem> payments() => const [
    ...
    RidePaymentItem(brand: 'cards', name: 'Card', detail: 'Visa, Mastercard'),
    RidePaymentItem(
      brand: 'swish',
      name: 'Swish',
