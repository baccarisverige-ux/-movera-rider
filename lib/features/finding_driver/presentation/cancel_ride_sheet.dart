...
Future<bool> showCancelRideSheet(
  ...
  final result = await showModalBottomSheet<bool>(
    ...
    builder: (_) => CancelRideSheet(takingLonger: takingLonger),
  );
  return result ?? true;
}

class CancelRideSheet extends StatelessWidget {
  const CancelRideSheet({super.key, required this.takingLonger});
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton(
              ...
              child: Text(
                takingLonger ? 'Keep searching' : 'Wait for driver',
                style: GoogleFonts.poppins(
                  fontWeight: FontWeight.w600,
                  fontSize: 16,
                  color: Colors.white,
