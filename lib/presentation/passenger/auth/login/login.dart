...
import 'package:movera_rider/presentation/passenger/auth/signup/signup.dart';
import 'package:movera_rider/presentation/passenger/auth/verify%20phone/verify_phone.dart';
import 'package:movera_rider/presentation/passenger/bottom%20navigation/bottom_navigation.dart';
import 'package:movera_rider/widgets/checkbox.dart';
...
import 'package:movera_rider/widgets/phone_picker.dart';
          ...
          children: [
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  RightToLeftTransition(PassengerVerifyPhone()),
                );
              },
            ),
            43.height,
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        RightToLeftTransition(PassengerSignup()),
                      );
                    },
                    child: TextWidget(
                      text: "Sign up",
